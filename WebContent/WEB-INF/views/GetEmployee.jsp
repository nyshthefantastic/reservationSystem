...
<body>
	...
	<br>
	<%
		Reservation employee = (Reservation) request.getAttribute("employee");
	%>
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="faculty"
					value="<%=employee.getContactNumber()%>" /></td>
			</tr>
			<tr>
				<td>Department</td>
				<td><input type="text" name="department"
					value="<%=employee.getResDate()%>" /></td>
			</tr>
			<tr>
				<td>Qualifications</td>
				<td><input type="text" name="qualification"
					value="<%=employee.getNoOfChairs()%>" /></td>
			</tr>
			<tr>
				<td>Gender</td>
